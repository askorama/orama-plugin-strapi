...
const HomePage = () => {
  ...
  const handleUpdate = async () => {
    ...
    setIsSaving(true)
    try {
      const collection = await put(`/${PLUGIN_ID}/collections/${currentCollection.id}`, currentCollection)
      toggleNotification({
        type: "success",
  ...
  const handleDelete = async () => {
    setIsModalVisible(false)
    try {
      await del(`/${PLUGIN_ID}/collections/${currentCollection.id}`)
      toggleNotification({
        type: "success",
  ...
  const handleDeploy = async () => {
    ...
    try {
      await post(`/${PLUGIN_ID}/collections/${currentCollection.id}/deploy`)
      toggleNotification({
        type: "success",
